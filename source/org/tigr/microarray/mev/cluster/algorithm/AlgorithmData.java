...
public class AlgorithmData implements Serializable {
    ...
    /**
     * Adds an array of GeneData objects, created by GSEA to the HahsMap gseaParam 
     * @param key
     * @param gData
     *
    
    public void addGeneData(String key, GeneData[]gData){
    	this.gseaParam.put(key, gData);
    	
    }
    
    /**
     * Adds an array of Geneset objects, generated by GSEA to the Hashmap gseaParam
     * @param key
     * @param gset
     *
    
    public void addGeneSet(String key, Geneset[]gset){
    	this.gseaParam.put(key, gset);
    }
    */
    /**
