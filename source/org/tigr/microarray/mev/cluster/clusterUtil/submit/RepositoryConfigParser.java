...
public class RepositoryConfigParser extends DefaultHandler {
    ...
    public String getRepositoryPage(String repName) {
        ...
        "<b>Repository Name:&nbsp&nbsp</b>"+ repName +"<br><br>"+
        "<b>Repository Web Site:&nbsp&nbsp</b>"+ getRepositoryURL(repName) +"<br><br>"+
        "<b>Description:&nbsp&nbsp</b>"+ getRepositoryDescription(repName) +"<br><br>";
