 ...
 *******************************************************************************/
/*
 * $RCSfile: DESEQInfoViewer.java,v $
 * $Revision: 1.9 $
 ...
 * @version 
 */
public class DESEQInfoViewer extends ViewerAdapter {
    
    private JComponent header;
    private JTextArea  content;
    private int upDown;
    /** Creates new DESEQInfoViewer */
    public DESEQInfoViewer(int[][] clusters, int genes, int upDown) {
    this.upDown = upDown;
	header  = createHeader();
	content = createContent(clusters, genes);
	setMaxWidth(content, header);        
    }
    public DESEQInfoViewer(JTextArea content, JComponent header){
    	this.header = header;
