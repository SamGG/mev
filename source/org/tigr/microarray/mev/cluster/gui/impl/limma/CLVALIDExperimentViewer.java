 ...
 * @version 
 */
public class CLVALIDExperimentViewer extends ExperimentViewer {
    ...
    public CLVALIDExperimentViewer(Experiment e, ClusterWrapper clusters, ClusterWrapper samplesOrder, Boolean drawAnnotations) {
    	super(e, clusters.getClusters(), samplesOrder.getClusters()[0], drawAnnotations);
    }
    	    
    public CLVALIDExperimentViewer(Experiment experiment, ClusterWrapper clusters, FloatMatrix geneGroupMeans, FloatMatrix geneGroupSDs, 
    ...
    public CLVALIDExperimentViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues) {
    ...
    public CLVALIDExperimentViewer(Experiment e, int[][] clusters, int[] samplesOrder, boolean drawAnnotations, 
    ...
    /** Creates new BETRExperimentViewer */
    public CLVALIDExperimentViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues, Object o, Object oo) {
	super(experiment, clusters);
	        this.rawPValues = rawPValues;
	        this.adjPValues = adjPValues;
	        this.fValues = fValues;
