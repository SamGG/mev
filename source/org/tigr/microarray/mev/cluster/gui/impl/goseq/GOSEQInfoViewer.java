 ...
 * @version 
 */
public class GOSEQInfoViewer extends ViewerAdapter {
    ...
    public GOSEQInfoViewer(int[][] clusters, int genes, int dd, int numGroups) {
    ...
    public GOSEQInfoViewer(JTextArea content, JComponent header){
    	this.header = header;
