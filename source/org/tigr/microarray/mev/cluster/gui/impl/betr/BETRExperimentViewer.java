 ...
 * @version 
 */
public class BETRExperimentViewer extends ExperimentViewer {
    ...
    public BETRExperimentViewer(Experiment e, int[][] clusters, int[] samplesOrder, boolean drawAnnotations, 
    ...
    /** Creates new BETRExperimentViewer */
    public BETRExperimentViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues, Object o, Object oo) {
	super(experiment, clusters);
	        this.rawPValues = rawPValues;
	        this.adjPValues = adjPValues;
	        this.fValues = fValues;
