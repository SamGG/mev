 ...
 */
public class NMFHCLExperimentViewer extends JPanel implements IViewer {
    
    private static final float INITIAL_MAX_VALUE = 1f;
    private static final float INITIAL_MIN_VALUE = 0f;
...
//     */
//    public NMFHCLExperimentViewer(Experiment experiment, int[][] clusters) {
...
//     * @param framework
//     */
//    public NMFHCLExperimentViewer(IFramework framework){
...
//     */
//    public NMFHCLExperimentViewer(Experiment experiment, int[][] clusters, boolean drawAnnotations) {
...
//     */
//    public NMFHCLExperimentViewer(Experiment experiment, int[][] clusters, int[] samplesOrder, Boolean drawAnnotations) {
...
//     * @param drawAnnotations
//     */
//    public NMFHCLExperimentViewer(Experiment experiment, ClusterWrapper clusters, ClusterWrapper samplesOrder, Boolean drawAnnotations) {
...
//    
    ...
    /**
     * This constructor is used to re-create an NMFHCLExperimentViewer from information
    ...
    /**
     * Launches a new <code>MultipleNMFHCLExperimentViewer</code> containing the current cluster
     */
    ...
    private int getMaxWidth(Graphics2D g) {
       ...
       for (int i=0; i<getCluster().length; i++) {
	       str = data.getElementAnnotation(getMultipleArrayDataRow(i), data.getFieldNames()[labelIndex]).toString();
