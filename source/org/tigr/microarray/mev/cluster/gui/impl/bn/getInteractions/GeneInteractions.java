...
public class GeneInteractions {
	...
	public static HashMap filter(HashMap artSymbols, HashMap symbolsArticles, int threshold) throws OutOfRangeException, NullArgumentException {
		...
		//System.out.println("artSymbols.size() " + artSymbols.size());
		...
		//System.out.println("Done each article key loop, article to remove " + articlesToRemove.size());
		//System.out.println("symbolsArticles.size() " + symbolsArticles.size());
		...
		while(itkeys2.hasNext()){
			...
			//System.out.println("Current Gene Sym " + symbol);
