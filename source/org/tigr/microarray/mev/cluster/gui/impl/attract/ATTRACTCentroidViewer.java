 ...
 * @version 
 */
public class ATTRACTCentroidViewer extends CentroidViewer {
    ...
    public ATTRACTCentroidViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues) {
     ...
     * @inheritDoc
     */
    public ATTRACTCentroidViewer(Experiment e, int[][] clusters, float[][] variances, float[][] means, float[][] codes, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues) {
     ...
     * @param clusters
     */
    public ATTRACTCentroidViewer(Experiment e, ClusterWrapper clusters) {
