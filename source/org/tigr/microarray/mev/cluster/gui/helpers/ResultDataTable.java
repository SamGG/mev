 ...
 * @author  dschlauch
 */
public class ResultDataTable implements IViewer {
    ...
    public ResultDataTable(double[][] ds, String[] measures) {
    	this(convertDMtoOM(ds), measures);
	}

	public ResultDataTable(HashMap optimalScores, String[] measures) {
		this(getObjectFromHashMap(optimalScores, measures), geCLVALIDTitles());
	}
    ...
    protected void addMenuItems(JPopupMenu menu, ActionListener listener) {
        ...
        menuItem = new JMenuItem("Sort table in original order...", GUIFactory.getIcon("TableViewerResult.gif"));
