...
public class AgilentMevFileLoader extends ExpressionFileLoader {
    ...
    public Vector loadExpressionFiles() throws IOException {
        ...
        this.loadMedianIntensities = amflp.loadMedButton.isSelected();
        ...
        if(amflp.noAnnFileBox.isSelected() || annFiles == null || annFiles.length == 0)
            haveAnnMatch = true;
        ...
        if(!haveAnnMatch) {
            ...
            JOptionPane.showMessageDialog(amflp, msg, "Annotation Mismatch Warning", JOptionPane.WARNING_MESSAGE);
        }
...
//      }
        ...
        if (mfp.isMevFileLoaded()) {
            ...
            if(i1 == -1 || i2 == -1) {
                if(loadMedianIntensities)
                    JOptionPane.showMessageDialog(amflp, "Error loading "+currentFile.getName()+"\n"
            ...
            for(int i = 0; i < data.length; i++){
                ...
                try {
                    ...
                    Thread thread = new Thread( new Runnable() {
                        public void run() {
                            JOptionPane.showConfirmDialog(amflp, "The input file \""+fileName+"\" was missing critical information on line # "+ String.valueOf(loc+1) + "\n" +
    ...
    public Vector loadAnnotationFile(SlideData targetData, File sourceFile) throws IOException {
        ...
        if(parser.isAnnFileLoaded()){
            ...
            String [][] annMatrix;
            //if(amflp.cutQuotesBox.isSelected())
