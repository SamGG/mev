...
public class RProgress {
	...
	public RProgress( JFrame jfP, String message ) {
		this.jf = jfP;
		...
		labelPanel.add( Box.createHorizontalGlue() );
		JLabel progressLabel2 = new JLabel( message );
	...
	public static void main( String[] args ) {
		RProgress rp = new RProgress( new JFrame(), 
				"As a reference, 4 arrays (640 genes) takes about half an hour" );
	}
}//end class