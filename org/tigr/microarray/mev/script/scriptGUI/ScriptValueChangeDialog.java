...
public class ScriptValueChangeDialog extends AlgorithmDialog {
    ...
    private void initializeValues() {
        //   StringTokenizer stok = new StringTokenizer(origLine, "value");
        String strPre;
        String strPost;
        ...
        if(pnt >= 0) {
            ...
            // System.out.println("stok token count ="+stok.countTokens());
       ...
       /* if(stok.countTokens() == 2) {
            prefix = createJLabel(stok.nextToken()+"value=\"");
            str = stok.nextToken();
            value = stok.nextToken("\"");
            valueComponent = getValueComponent(value);
            suffix = createJLabel("\""+stok.nextToken());
            System.out.println("Line ="+prefix.getText()+value+suffix.getText());
        } else {
        */
            prefix = createJLabel(" ");
            suffix = createJLabel(" ");
    ...
    private class ButtonPanel extends JPanel {
        ...
        /*
        JButton refreshBut = new JButton("Apply");
        ...
        refreshBut.setActionCommand("apply-cmd");
