...
public class PTMInitDialog extends AlgorithmDialog {   
    ...
    public PTMInitDialog(JFrame parentFrame, boolean modality, FloatMatrix expMatrix, Vector uniqueIDs, Vector sampleNamesVector, Vector clusters, Vector expClusters, Color[] clusterColors, Color[] expClusterColors) {        
        ...
        tabbedPane.addTab("Sample Templates", expSelectPanel);        
        tabbedPane.addTab("Sample Cluster Templates", clusterSelectPanel);        
        ...
        drawTreesBox = new JCheckBox("Construct Hierarchical Trees for:");        
        drawTreesBox.setFocusPainted(false);       
        
        sigOnly = new JRadioButton("Matched genes only", true);
        ...
        drawTreesPane.add(sigOnly, new GridBagConstraints(1,1,1,1,0,0,GridBagConstraints.WEST,GridBagConstraints.NONE,new Insets(0,30,0,20),0,0));
        drawTreesPane.add(allClusters, new GridBagConstraints(1,2,1,1,0,0,GridBagConstraints.WEST,GridBagConstraints.NONE,new Insets(0,30,0,20),0,0));        
    ...
    class ExperimentSelector extends JPanel{        
         ...
         */            
            ...
            selectButton = new JButton("Select highlighted samples from above list to use as template", GUIFactory.getIcon("select_check24.gif"));            
    ...
    class ExperimentClusterSelector extends JPanel {        
        ...
        ExperimentClusterSelector() {            
            ...
            if (expClusters.size() == 0) {                
                clusterNames.add("No sample clusters to show");                
            } else {                                
