...
public class PTMCentroidsViewer extends PTMSubCentroidsViewer {
     ...
     * and clusters.
     */
    public PTMCentroidsViewer(Experiment experiment, int[][] clusters, Vector templateVector) {
	super(experiment, clusters, templateVector);
