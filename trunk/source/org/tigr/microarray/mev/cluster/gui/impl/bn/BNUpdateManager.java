...
public class BNUpdateManager {
    ...
    public BNUpdateManager(final JFrame parent,String apath) {        
        frame = parent;
        path=apath;
        listener = new ProgressListener();
        //Initialize the progress bar
          progress = new Progress(parent, "File Update Progress", listener);                
    }
        ...
        try {
            ...
            if(okStatus) {          
            	...
            	if(dialog.showModal() == JOptionPane.OK_OPTION) {
            		...
            		//if implies files are already inside BN zip or does not exist clear boolean
            		...
            		//the repository file root for BN files, and the optional implies zip file name
    ...
    private File getOutputFileLocation() {
        ...
        msg += "For literature mining 3 sources of articles(Resourcerer, Entrez Gene, Pubmed) can be download to the directory \"bn\"<br>";
   
        msg += "</html>";
      
        HTMLMessageFileChooser chooser = new HTMLMessageFileChooser(frame, "BN Files Location", msg, TMEV.getFile("data"), true);
