 ...
 * @version 
 */
public class RPCentroidsViewer extends CentroidsViewer {
    ...
    /** Creates new RPCentroidsViewer */
    public RPCentroidsViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues) {
	 ...
	 * @inheritDoc
	 */
	public RPCentroidsViewer(CentroidViewer cv, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues) {
		super(cv);
		initialize(geneGroupMeans, geneGroupSDs, rawPValues, adjPValues, fValues, ssGroups, ssError, dfNumValues, dfDenomValues);
	}
	/**
