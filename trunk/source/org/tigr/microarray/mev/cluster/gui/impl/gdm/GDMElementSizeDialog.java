...
public class GDMElementSizeDialog extends JDialog {
    private int result;
   ...
   private final int maxSize = 30;
    ...
    public GDMElementSizeDialog(JFrame parent, Dimension elementSize) {
		...
		gba = new GBA();
		sizeLabel = new JLabel("Element square size (max = " + maxSize + "): ");
		sizeTextField = new JTextField(10);
		sizeTextField.setText("" + elementSize.width);
