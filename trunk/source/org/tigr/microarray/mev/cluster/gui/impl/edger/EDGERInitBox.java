 ...
 * @version 
 */
public class EDGERInitBox extends AlgorithmDialog {
    ...
    public EDGERInitBox(
        ...
        super(parentFrame, "edgeR Initialization", modality);
    ...
    class PValuePanel extends JPanel {
        ...
        public PValuePanel() {
            ...
            //fdrButton.setForeground(UIManager.getColor("Label.foreground"));
            //fdrButton.setBackground(Color.white);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(command.equals("ok-command")){
                ...
                try {               
                    ...
                    if (getTestDesign()==EDGERInitBox.ONE_CLASS){
                    	
                    } else if(getTestDesign()==EDGERInitBox.TWO_CLASS){
                    	if (getSelectionDesign()==EDGERInitBox.CLUSTER_SELECTION){
                    ...
                    // Validate cut-off
                    Float.parseFloat(pPanel.pValueInputField.getText());
                } catch (NumberFormatException nfe) {
                    JOptionPane.showMessageDialog(null, "Valid Cut-Off inputs: 0 < alpha < 1", "Error!", JOptionPane.ERROR_MESSAGE);
                    okPressed = false;
            		pPanel.pValueInputField.grabFocus();
                }
                if(!okPressed)
                	return;
    ...
    public static void main(String[] args) {
        ...
        EDGERInitBox oBox = new EDGERInitBox(dummyFrame, true, dummyVect, null);
