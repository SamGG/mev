 ...
 * @version
 */
public class LIMMAGUI implements IClusterGUI, IScriptGUI {
...
//        if (LIMMADialog.getSelectionDesign()==LIMMAInitBox.BUTTON_SELECTION){
        ...
        try {
            algorithm = framework.getAlgorithmFactory().getAlgorithm("LIMMA");
			...
			//TODO Raktim pass logfile name here
			//data.addParam("logfile",String.valueOf(logFile));
...
//        addCentroidViews(root);
    ...
    protected void addExpressionImages(DefaultMutableTreeNode root) {
        ...
        IViewer expViewer = new LIMMAExperimentViewer(this.experiment, clusters, null, null, null, null, null, null, null, null, null);
        int x=1; int y=2;
        for (int i=0; i<this.clusters.length; i++) {
    ...
    protected void addClusterInfo(DefaultMutableTreeNode root) {
        ...
        node.add(new DefaultMutableTreeNode(new LeafInfo("Results (#,%)", new LIMMAInfoViewer(this.clusters, this.experiment.getNumberOfGenes(), this.dataDesign, this.numGroups))));
        root.add(node);
    }
    ...
    protected void addCentroidViews(DefaultMutableTreeNode root) {
        ...
        //LIMMACentroidViewer centroidViewer = new LIMMACentroidViewer(this.experiment, clusters, geneGroupMeans, geneGroupSDs, rawPValues, adjPValues, fValues, ssGroups, ssError, dfNumValues, dfDenomValues);
        LIMMACentroidViewer centroidViewer = new LIMMACentroidViewer(this.experiment, clusters, null, null, null, null, null, null, null, null, null);
        ...
        LIMMACentroidsViewer centroidsViewer = new LIMMACentroidsViewer(this.experiment, clusters, geneGroupMeans, geneGroupSDs, null, null, null, null, null, null, null);
