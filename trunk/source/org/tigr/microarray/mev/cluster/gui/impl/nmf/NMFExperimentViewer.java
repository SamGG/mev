 ...
 *******************************************************************************/
/*
 * $RCSfile: NMFExperimentViewer.java,v $
 * $Revision: 1.10 $
 ...
 * @version 
 */
public class NMFExperimentViewer extends ExperimentViewer {
    ...
    public NMFExperimentViewer(Experiment e, ClusterWrapper clusters, ClusterWrapper samplesOrder, Boolean drawAnnotations) {
    	super(e, clusters.getClusters(), samplesOrder.getClusters()[0], drawAnnotations);
    }
    	    
    public NMFExperimentViewer(Experiment experiment, ClusterWrapper clusters, FloatMatrix geneGroupMeans, FloatMatrix geneGroupSDs, 
    ...
    /** Creates new NMFExperimentViewer */
    public NMFExperimentViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues) {
    ...
    public NMFExperimentViewer(Experiment e, int[][] clusters, int[] samplesOrder, boolean drawAnnotations, 
    ...
    /** Creates new NMFExperimentViewer */
    public NMFExperimentViewer(Experiment experiment, int[][] clusters, float[][] geneGroupMeans, float[][] geneGroupSDs, Vector rawPValues, Vector adjPValues, Vector fValues, Vector ssGroups, Vector ssError, Vector dfNumValues, Vector dfDenomValues, Object o, Object oo) {
	super(experiment, clusters);
	        this.rawPValues = rawPValues;
	        this.adjPValues = adjPValues;
	        this.fValues = fValues;
