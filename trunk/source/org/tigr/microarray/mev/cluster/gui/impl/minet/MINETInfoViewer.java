 ...
 *******************************************************************************/
/*
 * $RCSfile: MINETInfoViewer.java,v $
 * $Revision: 1.9 $
 ...
 * @version 
 */
public class MINETInfoViewer extends ViewerAdapter {
    
    private JComponent header;
    private JTextArea  content;
    private int upDown;
    /** Creates new MINETInfoViewer */
    public MINETInfoViewer(int[][] clusters, int genes, int upDown) {
    this.upDown = upDown;
	header  = createHeader();
	content = createContent(clusters, genes);
	setMaxWidth(content, header);        
    }
    public MINETInfoViewer(JTextArea content, JComponent header){
    	this.header = header;
