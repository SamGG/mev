 ...
 *******************************************************************************/
/*
 * $RCSfile: EDGERInfoViewer.java,v $
 * $Revision: 1.9 $
 ...
 * @version 
 */
public class EDGERInfoViewer extends ViewerAdapter {
    
    private JComponent header;
    private JTextArea  content;
    private int upDown;
    /** Creates new EDGERInfoViewer */
    public EDGERInfoViewer(int[][] clusters, int genes, int upDown) {
    this.upDown = upDown;
	header  = createHeader();
	content = createContent(clusters, genes);
	setMaxWidth(content, header);        
    }
    public EDGERInfoViewer(JTextArea content, JComponent header){
    	this.header = header;
