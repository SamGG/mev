 ...
 *******************************************************************************/
/*
 * $RCSfile: DAMResultConfigDialog.java,v $
 */
...
public class DAMResultConfigDialog extends AlgorithmDialog {
    private int result;
    ...
    /**
     * Constructs a <code>DAMResultConfigDialog</code> with specified initial parameters.
     */
    public DAMResultConfigDialog(Frame parent, float pointSize, float selectedPointSize, float scaleAxisX, float scaleAxisY, float scaleAxisZ) {
        super(new javax.swing.JFrame(), "DAM Result Configuration", true);
    ...
    public static void main(String [] args){
        DAMResultConfigDialog dialog = new DAMResultConfigDialog(new Frame(), 1,1,5,5,5);
        dialog.showModal();
    }
