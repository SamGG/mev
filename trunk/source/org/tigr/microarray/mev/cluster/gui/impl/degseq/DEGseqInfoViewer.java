 ...
 *******************************************************************************/
/*
 * $RCSfile: DEGseqInfoViewer.java,v $
 * $Revision: 1.9 $
 ...
 * @version 
 */
public class DEGseqInfoViewer extends ViewerAdapter {
    
    private JComponent header;
    private JTextArea  content;
    private int upDown;
    /** Creates new DEGseqInfoViewer */
    public DEGseqInfoViewer(int[][] clusters, int genes, int upDown) {
    this.upDown = upDown;
	header  = createHeader();
	content = createContent(clusters, genes);
	setMaxWidth(content, header);        
    }
    public DEGseqInfoViewer(JTextArea content, JComponent header){
    	this.header = header;
