 ...
 * @version 
 */
public class NMFInitBox extends AlgorithmDialog {
    ...
    /** Creates new NMFInitBox */
    public NMFInitBox(JFrame parentFrame, boolean modality, Vector<String> exptNames, ClusterRepository repository) {
        super(parentFrame, "NMF Initialization", modality);
        System.out.println("NMF init");
        System.out.println("NMF init again");
    ...
    class HCLoptionPanel extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3545681718086569386L;
    ...
    class MultiClassPanel extends JPanel {
        ...
        public MultiClassPanel(/*Vector exptNames*/) {
            ...
            topPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED), "NMF Parameters",TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, Color.black));
            buildConstraints(constraints, 0, 0,1,1,100,10);
            ...
            infoLabel2 = new JLabel("Please select the type of NMF analysis to be run, then click 'Continue'.");
            constraints.anchor = GridBagConstraints.CENTER;
        ...
        class NumTimePointsPanel extends JPanel {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -7843607819472354276L;
        ...
        class MultiGroupExperimentsPanel extends JPanel {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -3445895048195793913L;
			int numPanels = 0;
            JLabel[] expLabels;
...
//                panel1.setLayout(gridbag);
    ...
    class PermOrFDistPanel extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6120335735562471598L;
    ...
    class PValuePanel extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5847219210701857765L;
    ...
    public class EventListener extends WindowAdapter implements ActionListener{
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(command.equals("ok-command")){
                ...
                HelpWindow hw = new HelpWindow(NMFInitBox.this, "Non-negative Matrix Factorization - Initialization Dialog");
                okPressed = false;
    ...
    public int[][] getTimeMatrix(){
    	int[] timeAssignments;
    	if (getTestDesign()==NMFInitBox.CLUSTER_SELECTION){
    ...
    public int getTestDesign() {
        ...
        if (mPanel.tabbedmulg.getSelectedIndex() == 0) {
        	design = NMFInitBox.BUTTON_SELECTION;
        	} else {
        	design = NMFInitBox.CLUSTER_SELECTION;
        }
        return design;
    }
    ...
    public boolean validateFalseNum() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(NMFInitBox.this, "False number must be an integer >= 0", "Input Error", JOptionPane.WARNING_MESSAGE);
    ...
    public boolean validateFalseProp() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(NMFInitBox.this, "False proportion must be between 0 and 1", "Input Error", JOptionPane.WARNING_MESSAGE);
    ...
    public static void main(String[] args) {
        ...
        NMFInitBox oBox = new NMFInitBox(dummyFrame, true, dummyVect, null);
