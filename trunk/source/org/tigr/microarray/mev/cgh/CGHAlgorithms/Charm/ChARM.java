...
public class ChARM /*extends Thread*/ implements IClusterGUI{
	  ...
	  */
	  ...
	  /**
	   * Constructor for default execution
	   *
	   */
	   ...
	   */
	  /*
	  public ChARM(IData dat, IFramework frameWrk, ArrayList selExprs, 
			  ArrayList dispExprs, CharmGUI viewer, ResultContainer resContainer,
			  int[][] chrInds, int[] exprInds){
		  System.out.println("ChARM State Saving constructor");
		  this.data = dat;
		  this.frame = frameWrk;
		  this.selectedExps = selExprs;
		  this.displayExps = dispExprs;
		  this.charmViewer = viewer;
		  this.resultSet = resContainer;
		  this.chrIndices = chrInds;
		  this.exprInidces = exprInds;
	  }
	  */
	  /**
	   * Class constructor
	...
	*/
	  ...
	  public ResultContainer getSelectedResultSets() {
		...
		//System.out.println("getSelectedResultSets()");
	    return resultSet;
	  }
	  ...
	  public void setSelectedResultSets(ResultContainer result){
		  //System.out.println("setSelectedResultSets()");
		  if(result == null)
	  ...
	  public CharmGUI getCharmGUI() {
		  //System.out.println("getCharmGUI()");
	  ...
	  public void setCharmGUI(CharmGUI gui) {
		  //System.out.println("setCharmGUI()");
		  if(gui ==null)
	  ...
	  public ArrayList getPredictionSegments(/*String resultSet,*/ String exp, int chromosome) {
		  //System.out.println("ChARM.getPredictionSegments(): PVal: Test: " + currPvalueCutoff.getMeanPvalue()
				  //+ "," + currPvalueCutoff.getSignPvalue() + ":" + pvalTestType);
		  ...
		  //System.out.println("ChARM.getPredictionSegments() segments.size()" + tempList.size());
	  ...
	  public void setGraphMode(String mode) {
		...
		/*
		public void getGraphPanel(GraphViewPanel panel) {
			  //return charmMain.graphPanel;
			  charmViewer.setGraphViewPanel(panel);
		}
		*/
