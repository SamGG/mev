...
public class CASTInfoViewer extends ViewerAdapter implements java.io.Serializable {
    ...
    /**
     * Constructs a <code>CASTInfoViewer</code> with specified
     * clusters and number of genes.
     */
    public CASTInfoViewer(int[][] clusters, int genes) {
        header  = createHeader();
     ...
     * clusters and number of genes.
     */
    public CASTInfoViewer(int[][] clusters, int genes, boolean clusterGenes) {
        header  = createHeader();
