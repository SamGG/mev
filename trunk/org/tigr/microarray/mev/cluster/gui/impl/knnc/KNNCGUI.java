 ...
 * @author  nbhagaba
 */
public class KNNCGUI implements IClusterGUI{
    ...
    private DefaultMutableTreeNode createResultTree(Cluster result_cluster, GeneralInfo info) {
        ...
        if(classifyGenes)
            ...
            root = new DefaultMutableTreeNode("KNNC - experiments");
    ...
    private void addClusterInfo(DefaultMutableTreeNode root) {
        ...
        if(this.classifyGenes)
            ...
            node.add(new DefaultMutableTreeNode(new LeafInfo("Experiments in Classes (#,%)", new KNNCInfoViewer(this.clusters, this.experiment.getNumberOfSamples(), false, numClasses))));
        root.add(node);
    }   
