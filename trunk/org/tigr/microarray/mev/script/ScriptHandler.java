...
//        Element nameElement;, paramsElement, paramElement, keyElement, valueElement;
    ...
    public static void main(String [] args) {
        ScriptHandler hand = new ScriptHandler();
...
/*
        ...
        outArray[0] = "n-dim";
        data.addStringArray("output-array", outputArray);
        hand.appendAlgorithm(data,1, 1);
 */
        ...
        hand.appendAlgorithm(data, 1, 1, 1);
        ...
        hand.appendAlgorithm(data, 2, 1, 1);
        ...
        try {
            ...
            hand.writeDocument("C:\\Temp\\kmc_script.xml");
